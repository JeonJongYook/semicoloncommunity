	...
	<div class="login">
		...
		<form class="LoginForm">
			...
			<p class="buttons">
				...
				<button @click="checkAll" class="button blue" name="loginButton" id="loginButton">로그인</button>
				<button @click="doCancel" class="button" name="cancelButton" id="cancelButton">취소</button>
			</p>
		</form>
		<p>{{ errorMessage }}</p>
	</div>
